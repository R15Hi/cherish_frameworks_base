...
public class BatteryMeterView extends LinearLayout implements DarkReceiver {
    ...
    void scaleBatteryMeterViews() {
        ...
        batteryHeight = mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_A || mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_A
                    || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_B ||mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_B ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_style_a_b) : batteryHeight;
        batteryWidth = mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_A || mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_A
                    || mBatteryStyle == BATTERY_STYLE_RLANDSCAPE_STYLE_B ||mBatteryStyle == BATTERY_STYLE_LANDSCAPE_STYLE_B ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_style_a_b) : batteryWidth; 
        batteryHeight = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_SIGNAL || mBatteryStyle == BATTERY_STYLE_LANDSCAPE_MUSKU ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_signal_musku) : batteryHeight;
        batteryWidth = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_SIGNAL || mBatteryStyle == BATTERY_STYLE_LANDSCAPE_MUSKU ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_signal_musku) : batteryWidth; 
		...
		batteryHeight = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_PILL ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_height_landscape_pill) : batteryHeight;
		batteryWidth = mBatteryStyle == BATTERY_STYLE_LANDSCAPE_PILL ?
                res.getDimensionPixelSize(R.dimen.status_bar_battery_icon_width_landscape_pill) : batteryWidth; 
